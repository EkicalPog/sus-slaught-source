	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'sus-slaught' :
				{
					defaultCamZoom = 0.9;
					curStage = 'sus-slaught';
					var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('SUS/scary_sky'));
					bg.updateHitbox();
					bg.active = false;
					bg.antialiasing = true;
					bg.scrollFactor.set(0.1, 0.1);
					...
					var ground:FlxSprite = new FlxSprite(-537, -158).loadGraphic(Paths.image('SUS/GlitchedGround'));
					ground.updateHitbox();
					ground.active = false;
